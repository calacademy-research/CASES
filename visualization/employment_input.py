...
class EmploymentInput:
    ...
    def __init__(self):
        ...
        self.employment_sector_mappings = self.read_input_mappings("employment_input_data_sector_mappings.tsv")
 ...
 # entry point
    def read_data(self):
        ...
        for id in failed_loads:
            if id in self.employment_sector_mappings.keys():
    ...
    def load_employemnt_data(self,id,employment_filename):
        ...
        for row in read_tsv:
            ...
            if months is None and row[0].startswith("#"):
                ...
                sector_name = self.employment_sector_mappings[row[0]]
